...
first five terms are binary forms of some ascii values which when translated **CSOC2** is obtained used this [website](https://www.rapidtables.com/convert/number/binary-to-ascii.html)
<br>
next seven terms are hex values which when translated **3{ju57_**same website  can translate hex to text
<br>
next strng is base64 encoded when decoded it gives **d1ff3r3n7_3nc**
<br>
